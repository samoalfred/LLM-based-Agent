%% Pure ReAct Agent for Helicene HOMO-LUMO Gap Fitting (GPT-4 Version) - PORTABLE VERSION
...
%% Initialize AI Model for ReAct Reasoning - GPT-4
ai_model = openAIChat([ ...
...
fprintf('\n=== Pure ReAct Agent for Helicene HOMO-LUMO Gap Fitting (GPT-4) Started ===\n');
...
function [result, agent_state] = action_extract_equation(~, agent_state)
    ...
    try
        ...
        % Create extractor - GPT-4 version
